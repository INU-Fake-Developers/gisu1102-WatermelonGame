...
// 무적 모드：true 고치기 false
let wuDi = true;

// 첫 번째 과일: 수정숫자는 0-10, 0은 포도, 9는 수박 반 개이다.
let firstFruit = 0;

// 과일 합성 반전：false 고치기 true
...
const maxRandomFruitNum = reverseLevelUp ? 11 : 2; // 생성된 임의과일 최대치(1-11) 0은 포도, 9는 수박 반개
let setFruits = {
  //지정 전에 몇 번 생성된 과일은 임의의 수량을 채울 수 있습니다. 0은 포도, 9는 수박 반 개입니数（推荐 0.9）다.
